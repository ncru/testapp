...
ActiveRecord::Schema[7.0].define(version: 2023_05_15_031849) do
  ...
  create_table "sales_job_orders", force: :cascade do |t|
    t.string "order_number"
    t.string "client_name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "fabric_selection"
  end

  create_table "suit_job_orders", force: :cascade do |t|
